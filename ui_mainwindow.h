...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuSelect_State->setGeometry(QRect(328, 116, 171, 150));
        menuMaryland = new QMenu(menuSelect_State);
        menuMaryland->setObjectName(QStringLiteral("menuMaryland"));
        menuNorth_Carolina = new QMenu(menuSelect_State);
        menuNorth_Carolina->setObjectName(QStringLiteral("menuNorth_Carolina"));
        menuWyoming = new QMenu(menuSelect_State);
        menuWyoming->setObjectName(QStringLiteral("menuWyoming"));
        ...
        menuSelect_State->addAction(menuMaryland->menuAction());
        menuSelect_State->addAction(menuNorth_Carolina->menuAction());
        menuSelect_State->addAction(menuWyoming->menuAction());
        menuSelect_State->addAction(actionExit);
        menuMaryland->addAction(actionMD8);
        menuMaryland->addSeparator();
        menuMaryland->addAction(actionMD2);
        menuMaryland->addAction(actionMD4);
        menuMaryland->addAction(actionMD6);
        menuMaryland->addAction(actionMD10);
        menuMaryland->addAction(actionMD12);
        menuMaryland->addAction(actionMD14);
        menuMaryland->addAction(actionMD16);
        menuNorth_Carolina->addAction(actionNC13);
        menuNorth_Carolina->addSeparator();
        menuNorth_Carolina->addAction(actionNC1);
        menuNorth_Carolina->addAction(actionNC3);
        menuNorth_Carolina->addAction(actionNC5);
        menuNorth_Carolina->addAction(actionNC7);
        menuNorth_Carolina->addAction(actionNC9);
        menuNorth_Carolina->addAction(actionNC11);
        menuNorth_Carolina->addAction(actionNC15);
        menuWyoming->addAction(actionWY1);
        menuWyoming->addSeparator();
        menuWyoming->addAction(actionWY2);
        menuWyoming->addAction(actionWY3);
        menuWyoming->addAction(actionWY4);
        menuWyoming->addAction(actionWY5);
        menuWyoming->addAction(actionWY6);
        menuWyoming->addAction(actionWY7);
        menuWyoming->addAction(actionWY8);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuWyoming->setTitle(QApplication::translate("MainWindow", "Wyoming", Q_NULLPTR));
    } // retranslateUi
